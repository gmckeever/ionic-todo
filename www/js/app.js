...
.factory('Projects', function() {
  return {
    ...
    .controller('TodoCtrl', function($scope, $firebase, $timeout, Modal, Projects) {
        ...
        $scope.projectsList = $firebase(new Firebase("https://nitrous-io.firebaseio.com/projects"));
        $scope.user = $firebase(new Firebase("https://nitrous-io.firebaseio.com/Users/Greg"));
